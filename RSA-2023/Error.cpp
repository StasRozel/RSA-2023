...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(204, "Лексическая ошибка: Присвоение значения выходящего за допустимый диапозон"),
		ERROR_ENTRY_NODEF(205), ERROR_ENTRY_NODEF(206), ERROR_ENTRY_NODEF(207), ERROR_ENTRY_NODEF(208), ERROR_ENTRY_NODEF(209), ERROR_ENTRY_NODEF10(210),
		...
		ERROR_ENTRY(304, "Семантическая ошибка: В объявлении отсутствует ключевое слово variable:"),
